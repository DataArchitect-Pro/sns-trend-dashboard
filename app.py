...
if df.empty:
    ...
    with col_err_left:
        ...
        # 推奨アクションの1番目を強力なCTA風カードに昇華
        st.markdown(f"""
        <div style="margin-top: 16px; margin-bottom: 8px; font-weight: bold; color: #1976d2;">💡 推奨されるアクション</div>
        <div style="background-color: #f0f7ff; border: 2px solid #90caf9; border-radius: 8px; padding: 12px; margin-bottom: 12px;">
        ...
        <div style="margin-left: 8px; color: #444; font-size: 0.95em; line-height: 1.6;">
            2. より投稿数が多く、具体的な本文を含むCSVに差し替える<br>
    ...
    with col_err_right:
        # メタデータを活用した解析状況パネル（媒体内訳等を整理し、重要項目を強調）
        ...
        <div style="background-color: #f9f9fc; padding: 20px; border-radius: 8px; border: 1px solid #e0e0e0;">
            ...
            <span style="color: #777; font-size: 0.85em; margin-left: 12px;">スパム除外：{spam_dropped}件</span><br><br>
